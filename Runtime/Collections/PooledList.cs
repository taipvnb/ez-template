...
namespace com.ez.engine.foundation.collections
{
	...
	[Serializable]
	public partial struct PooledList<T> : IList<T>, IReadOnlyList<T>, IDeserializationCallback
	{
		...
		private static readonly bool s_clearItems = RuntimeHelpers.IsReferenceOrContainsReferences<T>();
		...
		public int Count
		{
			[MethodImpl(MethodImplOptions.AggressiveInlining)] get => _size;
		}
		...
		private void Grow(int capacity)
		{
			...
			if ((uint)newcapacity > SystemArray.MaxLength)
				newcapacity = SystemArray.MaxLength;
