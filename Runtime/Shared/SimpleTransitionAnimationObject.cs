...
namespace com.ez.engine.manager.ui
{
	public class SimpleTransitionAnimationObject : TransitionAnimationObject
	{
		...
		[SerializeField] private Alignment _beforeAlignment = Alignment.Center;
		[SerializeField] private Vector3 _beforeScale = Vector3.one;
		[SerializeField] private float _beforeAlpha = 1.0f;
		[SerializeField] private Alignment _afterAlignment = Alignment.Center;
		...
		public static SimpleTransitionAnimationObject CreateInstance(float? duration = null, EaseType? easeType = null,
			Alignment? beforeAlignment = null, Vector3? beforeScale = null, float? beforeAlpha = null,
			Alignment? afterAlignment = null, Vector3? afterScale = null, float? afterAlpha = null)
		{
		...
		public void SetParams(float? duration = null
