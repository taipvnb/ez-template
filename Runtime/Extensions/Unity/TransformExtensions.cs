...
namespace com.ez.engine.foundation
{
    ...
    public static class TransformExtensions
    {
        ...
        /// <summary> Destroy all children immediately, only advisable in the Editor. </summary>
        ...
        /// <summary> Destroy all children immediately, using DestroyImmediate in the Editor and Destroy outside it. </summary>
        ...
        /// <summary> All their children. </summary>
        ...
        /// <param name="x">X axis</param>
        /// <param name="y">Y axis</param>
        public static void ScaleByXY(this Transform self, float x, float y) =>
            self.localScale = new Vector3(self.localScale.x * x, self.localScale.y * y, self.localScale.z);
        ...
        /// <param name="y">Y axis</param>
        /// <param name="z">Z axis</param>
        public static void ScaleByYZ(this Transform self, float y, float z) =>
            self.localScale = new Vector3(self.localScale.x, self.localScale.y * y, self.localScale.z * z);
        ...
        /// <summary> Reset the transforms local position, rotation and scale. </summary>
        /// <param name="self">Transform</param>
        ...
        /// <summary> Reset the rect transforms local position, rotation and scale. Also offsetMax and offsetMin. </summary>
        /// <param name="self">RectTransform</param>
        ...
        /// <summary> Get all transforms children </summary>
        /// <param name="self">Transform</param>
